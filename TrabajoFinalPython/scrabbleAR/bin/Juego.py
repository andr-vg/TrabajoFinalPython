...
def main(guardado):
    ...
    palabras_usadas = []
    layout, letras, letras_pc, botones, long_tablero = gm.crear_layout(bolsa,tab ,dificultad, tipo_palabra, img_nros, puntos_por_letra, nombre, palabras_usadas, guardado)  # botones es un diccionario de pares (tupla, valor)
