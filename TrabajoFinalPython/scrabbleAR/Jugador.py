...
class Jugador(Jugadores):
    ...
    def _analizo(self, keys_ordenados, menor_1, menor_2, j, k): # menor_1 = fila_menor (caso horizontal) o columna_menor (caso vertical) 
    ...
    def jugar(self, palabra_nueva, letras_usadas, posiciones_ocupadas_tablero, primer_turno): # ex confirmar palabra de nivel1
        ...
        if not self._analizo(keys_ordenados, fila_menor, columna_menor, 0, 1) and not self._analizo(keys_ordenados, columna_menor, fila_menor, 1, 0):
